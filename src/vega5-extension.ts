/**
 * Copied from https://github.com/jupyterlab/jupyterlab/blob/65d78caa2b4c0e0cc5f7838815031c33401fa46a/packages/vega5-extension/src/index.ts
 * Except changed extension ID.
 */
...
const extension: IRenderMime.IExtension = {
  id: '@jupyterlab/vega-extension:factory-2',
  rendererFactory,
  rank: 50,
  dataType: 'json',
